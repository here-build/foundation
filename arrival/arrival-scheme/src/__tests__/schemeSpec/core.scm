...
(test "core: async for-each"
  (lambda (t)
    ...
    (let* ((result (vector))
      ...
      (t.is result (--> (vector 0) (concat (list->vector numbers) (vector (+ count 1))))))))
...
(test "core: try..catch should stop execution for-each #163"
  (lambda (t)
    ...
    (t.is (until-zero identity '(1 2 3 4 0 10 20 30)) (vector 1 2 3 4))
    (t.is (until-zero identity '(0 1 2 3 4)) (vector))))
...
(test "core: iterator->array"
  (lambda (t)
    (t.is (iterator->array '(1 2 3 4)) (vector 1 2 3 4))
...
(test "core: number->string"
  (lambda (t)
    ...
    (t.is (number->string 1 .0 e-27 16) "4.f3a68dbc8f04e-17")
    (t.is (number->string 1 .0 e+27 16) "3.3b2e3c9fd0804e+16")
