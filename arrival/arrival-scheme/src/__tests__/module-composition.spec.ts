...
describe("Environment Module Composition", () => {
  describe("Environment.fromModules", () => {
    ...
    it("should chain modules with parent relationships", () => {
      ...
      const env = Environment.fromModules([baseModule, childModule]);
    ...
    it("should resolve dependencies in correct order", () => {
      ...
      const env = Environment.fromModules([moduleC, moduleA, moduleB]);
    ...
    it("should detect circular dependencies", () => {
      ...
      expect(() => Environment.fromModules([moduleA, moduleB])).toThrow(/Circular dependency/);
    });
    ...
    it("should throw on missing dependency", () => {
      ...
      expect(() => Environment.fromModules([module])).toThrow(/depends on unknown module/);
    });

    it("should throw on empty modules array", () => {
      expect(() => Environment.fromModules([])).toThrow(/No modules provided/);
    });
  });
  ...
  describe("Resolver Yielding", () => {
    ...
    it("should walk parent chain with per-module resolution", () => {
      ...
      const env = Environment.fromModules([base, middle, top]);
  ...
  describe("Module with Bootstrap Code", () => {
    it("should execute bootstrap code when exec is provided", () => {
      ...
      const env = Environment.fromModules([module], mockExec);
    ...
    it("should execute bootstrap in dependency order", () => {
      ...
      Environment.fromModules([moduleB, moduleA], mockExec);
  ...
  describe("Practical Module Patterns", () => {
    ...
    it("should allow module to shadow parent resolver with binding", () => {
      ...
      const env = Environment.fromModules([parentModule, childModule]);
